...
export const routes: Routes = [
  ...
  { path: 'git-repos', loadComponent: () => import('./git-repos/git-repos').then(m => m.GitRepos) },
  { path: 'git-repos/:repo', loadComponent: () => import('./git-repos/git-repos').then(m => m.GitRepos) },
  { path: 'git-repos/:repo/:branch', loadComponent: () => import('./git-repos/git-repos').then(m => m.GitRepos) },
  { path: 'diagrams', loadComponent: () => import('./diagrams/diagrams').then(m => m.Diagrams) },
  { path: 'processing', loadComponent: () => import('./processing/processing').then(m => m.Processing) },
  { path: 'data-flow', loadComponent: () => import('./data-flow/data-flow').then(m => m.DataFlow) },
